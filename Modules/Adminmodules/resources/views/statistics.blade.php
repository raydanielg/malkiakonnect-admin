        ...
        <div class="sm:ml-64">
            ...
            <main class="px-4 sm:px-6 py-6">
                <div class="bg-white rounded-2xl border border-slate-200 p-6">
                    ...
                    <h1 class="mt-1 text-2xl font-extrabold text-slate-900">Statistics</h1>
                    <p class="mt-2 text-slate-600">This is the statistics page. Add charts and reports here.</p>
                </div>
